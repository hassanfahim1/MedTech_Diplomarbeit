 ...
 * Basiert auf bewährtem v7 Code mit 5900 Steps für 10ml
 */
...
#define BTN_FILL 7          // Füllen (Links = -5900) - GETAUSCHT!
#define BTN_EMPTY 5         // Entleeren (Rechts = +5900) - GETAUSCHT!
...
int stepSize = 5900;         // Schritte pro Tastendruck - für 10ml Spritze

// Debounce (wie v7)
unsigned long lastDebounceTime = 0;
unsigned long debounceDelay = 50;

// Spritzenpumpe Parameter - 10ml Spritze
float targetVolume = 10.0;   // ml - 10ml Spritze
const float STEPS_PER_ML = 590.0;  // 5900 Steps ÷ 10ml = 590 Steps/ml
int totalSteps = 0;

// Sicherheits-Grenzen
const int MAX_STEPS = 0;        // Nullstelle - kann nicht weiter entleeren  
const int MIN_STEPS = -5900;    // Maximum gefüllt - kann nicht weiter füllen
...
void loop() {
  ...
  // FILL Button (Links = -5900, GETAUSCHT - jetzt Pin 7!)
  ...
  // EMPTY Button (Rechts = +5900, GETAUSCHT - jetzt Pin 5!)
 ...
 * I2C LCD:    SDA, SCL
 * 
 * FUNKTIONEN (10ml Spritze):
 * - FILL (Pin 7):  Dreht -5900 Schritte (links) für 10ml
 * - EMPTY (Pin 5): Dreht +5900 Schritte (rechts) für 10ml
 * - START/STOP: Kontinuierliche Drehung oder Stop
 * - Stop funktioniert IMMER, auch während 5900-Steps
 * - Stop zeigt nur Volumen ohne Zeit
 * - 5900 Steps = 10ml (590 Steps/ml)
 */
